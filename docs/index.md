...
**The current version of `crystmatch` is `2.0.4`.**
...
!!! danger "Important"
    By default, the fractional coordinates in the POSCAR files will be added and subtracted by integers to optimize the CSM. If you are reading a pair of POSCAR files generated by `crystmatch`, you should use `--literal` to disable this behavior. See [all options](http://127.0.0.1:8000/cli/#all-options) for details.
