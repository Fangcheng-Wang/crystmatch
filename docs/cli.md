...
- `-f`, `--fix-integer`
    ...
    Do not add or subtract integers to the fractional coordinates when using `--direct`.

    !!! warning "Caveat"
        If you are reading a pair of POSCAR files generated by `crystmatch`, you should use this option, or the CSM may be altered.
