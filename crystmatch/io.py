...
def load_poscar(filename: str, to_primitive: bool = True) -> Cryst:
    ...
    print('Space group: ' + get_spacegroup((lattice, positions, numbers)))
    if to_primitive:
...
def cryst_interpolation(crystA_sup: Cryst, crystB_sup: Cryst, num: int) -> List[Cryst]:
    """
...
def save_trajectory(filename: str, crystA_sup: Cryst, crystB_sup: Cryst, num: int = 50, crystname: Union[str, None] = None) -> None:
    """
    ...
    """
    crystlist = cryst_interpolation(crystA_sup, crystB_sup, num)
